...
#include <elan_juce_helpers/elan_juce_helpers.h>
...
#include <se_framework/se_framework.h>
...
{
    const char* const  projectName    = "PrettyScope";
    const char* const  companyName    = "Soundemote";
